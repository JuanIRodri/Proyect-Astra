...
export function PhaserGame({ personajes, onStatusChange, onOpenCharacterEditor, onToggleInventory }) {
  ...
  }, [onStatusChange, onOpenCharacterEditor, onToggleInventory, personajes])
